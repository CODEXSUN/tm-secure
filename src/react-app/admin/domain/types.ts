...
export interface DesktopLicense { id: string; appId: string; applicationName: string; lastFour: string; status: string; machineLabel: string | null; issuedAt: string; activatedAt: string | null; lastValidatedAt: string | null; revokedAt: string | null }
