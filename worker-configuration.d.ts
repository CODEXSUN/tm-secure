/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e13ea1b4d9774db5ff19b8194f303699)
// Runtime types generated with workerd@1.20260828.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
	tm_secure_db: D1Database;
	OTP_HMAC_KEY: string;
	RESEND_API_KEY: string;
	HOSTINGER_SMTP_PASSWORD: string;
	HOSTINGER_SMTP_HOST: string;
	HOSTINGER_SMTP_PORT: string;
	HOSTINGER_SMTP_USERNAME: string;
	HOSTINGER_SMTP_FROM: string;
	NODE_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OTP_HMAC_KEY" | "RESEND_API_KEY" | "HOSTINGER_SMTP_PASSWORD" | "HOSTINGER_SMTP_HOST" | "HOSTINGER_SMTP_PORT" | "HOSTINGER_SMTP_USERNAME" | "HOSTINGER_SMTP_FROM" | "NODE_ENV" | "AUTH_BYPASS_ENABLED">> {}
}
